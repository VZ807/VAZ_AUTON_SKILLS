...
extern pros::MotorGroup right_mg; // Creates a motor group with forwards ports 1
                                  // & 3 and reversed port 2
extern pros::MotorGroup left_mg;  // Creates a motor group with forwards port 5
                                  // and reversed ports 4 & 6
